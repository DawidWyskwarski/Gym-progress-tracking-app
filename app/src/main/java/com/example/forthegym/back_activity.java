...
public class back_activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(exercises.isEmpty()) {
            exercises.add(new Exercises("Pull Ups (BW)"));
            exercises.add(new Exercises("Lat Pull Downs (M)"));
            exercises.add(new Exercises("Lat Pullover (C)"));
            exercises.add(new Exercises("Lever Row (M)"));
            exercises.add(new Exercises("Row (BB)"));
            exercises.add(new Exercises("Seated Row (M)"));
            exercises.add(new Exercises("Single Arm Seated Row (C)"));

            exercises.add(new Exercises("Shrugs (DB)"));
            exercises.add(new Exercises("Shrugs (BB)"));

            exercises.add(new Exercises("Face Pulls (C)"));
            exercises.add(new Exercises("Reverse Fly (M)"));
            exercises.add(new Exercises("Rear Delt Fly (C)"));
    ...
    private void readFile() {
        File file = new File(getFilesDir(), "back_exercises.ser");
        if (!file.exists()) {
            return;
        }
